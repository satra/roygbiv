MultiModalViewerPlugin = {
  name: "MultiModal Viewer",
  filetypes: ["nrrd", "mgh", "mgz"],
  ...
  loadControls: function(div){
	console.log("controls");
  }
};

nv_plugins[MultiModalViewerPlugin.name] = MultiModalViewerPlugin;
